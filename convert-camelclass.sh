...
sed -i -e "s/<\/fileSets>/<\/fileSets>${REQUIRED_PROPERTIES}/" src/main/resources/META-INF/maven/archetype-metadata.xml

echo "ProjectName=basic" >>src/test/resources/projects/basic/archetype.properties

sed -i -e "s/public class ProjectName/public class \${ProjectName}/" src/main/resources/archetype-resources/src/main/java/config/app/__ProjectName__*.java
sed -i -e "s/config\.app\.ProjectName/config\.app\.\${ProjectName}/" src/main/resources/archetype-resources/src/main/java/config/app/__ProjectName__*.java
sed -i -e "s/\(ProjectName\)\([A-Za-z]*Config\.class\)/\${ProjectName}\2/g" src/main/resources/archetype-resources/src/main/java/config/app/*.java
